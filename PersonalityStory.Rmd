...
```{r: export tables sjPlot, echo=FALSE}
sjt.lm(grmrec.personality.scaled.lm, grmrecNonkin.personality.scaled.lm, hud.personality.scaled.lm, hudkin.personality.scaled.lm)
```
